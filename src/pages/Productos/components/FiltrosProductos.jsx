  ...
  return (
    <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm space-y-6">
      ...
      <div className="flex items-center">
        <button className="flex items-center gap-2 bg-[#895202] hover:bg-[#6d4102] text-white px-6 py-2.5 rounded-lg font-bold text-sm transition-all active:scale-95 shadow-md shadow-orange-900/10">
